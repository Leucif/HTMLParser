...
public List<DataBox> getContent(String url, String[] pages, String dataFilter) throws IOException {
	Document page;
	...
	for (int i = 0; i < pages.length; i++) {
		...
		contentElements.forEach(contentElement -> parsedInfoImages.add(url+ contentElement.attr("src")));
...
public DataBox getContent(String url, String dataFilter) throws IOException {
